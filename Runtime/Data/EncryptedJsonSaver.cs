...
namespace EyapLibrary.Data
{
    ...
    public class EncryptedJsonSaver<T> : JsonSaver<T> where T : IDataStore
    {
        ...
        {
            0x6b, 0xb0, 0xa1, 0x65, 0x08, 0xf8, 0xe6, 0x47, 0x4d, 0x9e, 0x2f, 0x19, 0x97, 0xec, 0x0d, 0x6e,
            0xe7, 0xec, 0xe2, 0x0a, 0xd9, 0xe8, 0xa7, 0x8d, 0xff, 0x3d, 0xe1, 0x65, 0x4f, 0x46, 0x00, 0x22
        };
        ...
        {
            FileStream underlyingStream = new FileStream(_filePath, FileMode.Create);
            ...
            CryptoStream encryptedStream = new CryptoStream(underlyingStream, rijndael.CreateEncryptor(), CryptoStreamMode.Write);
        ...
        {
            FileStream underlyingStream = new FileStream(_filePath, FileMode.Open);
            ...
            CryptoStream encryptedStream = new CryptoStream(underlyingStream, rijndael.CreateDecryptor(), CryptoStreamMode.Read);
